	...
	public function index(){
		...
		if ($this->session->userdata('username') == '') {
			...
			if ($this->session->userdata('lvl') == 1) {
				$data['sidebar'] =$this->load->view('sidebar_Dokter','', TRUE);
				//echo "level 1";
			}
			elseif ($this->session->userdata('lvl') == 2) {
				$data['sidebar'] =$this->load->view('sidebar_Perawat','', TRUE);
				//echo "level 2";
			}
			elseif ($this->session->userdata('lvl') == 3) {
				$data['sidebar'] =$this->load->view('sidebar_Apoteker','', TRUE);
				//echo "level 3";
			}
			else {
				$data['sidebar'] =$this->load->view('sidebar_fo','', TRUE);
				//echo "level 4";
			}
		}
